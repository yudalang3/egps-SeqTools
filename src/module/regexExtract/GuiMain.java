...
public class GuiMain extends ModuleFace {
	...
	private VOICM4RegexExtract voicm4TreeLeafInforObtainer;
	...
	protected GuiMain(IModuleLoader moduleLoader) {
		...
		voicm4TreeLeafInforObtainer = new VOICM4RegexExtract(this);
	}
	...
	public String[] getFeatureNames() {
		return new String[] {"Extract text by regex"};
	}
	public void recordTheFunctionInvoke() {
		recordFeatureUsed4user("Extract text by regex");
	}
